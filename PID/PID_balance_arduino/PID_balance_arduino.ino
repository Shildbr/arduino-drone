...
void loop() {
  ...
  *multiplied by the error*/
  ...
  /*A última parte é a derivada. A derivada atua sobre a velocidade do erro.
  Como sabemos, a velocidade é a quantidade de erro produzida em um determinado período de
  tempo dividido por esse mesmo tempo. Para isso, usaremos uma variável chamada previous_error.
  Subtraímos esse valor do erro real e dividimos tudo pelo tempo decorrido. 
  Por fim, multiplicamos o resultado pela constante derivada*/
